...
class Service {
    ...
    insertOne(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newUser = yield user_model_1.UserModel.insertOne(data);
            return newUser;
        });
    }
    updateOne(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedUser = yield user_model_1.UserModel.updateOne(id, data);
            return updatedUser;
        });
    }
    deleteOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const updatedUser = yield user_model_1.UserModel.deleteOne(id);
            return updatedUser;
        });
    }
}
